...
class GetQueueHeader extends Component {
    ...
    componentDidMount() {
        ...
        businessService.findQuantityDetail(this.state.storeName)
            .then((res) => {
                console.log(res.data);
                this.setState({
                    queueDetail: res.data.QueueDetail
                })
            })

        businessService.getIconImg(this.state.storeName)
            .then((res) => {
                ...
                <Container>
                    <Row style={{ justifyContent: "center" ,marginBottom: "2%" , padding: 0}}>
                        <Col xs={5} sm={3} md={7}>
                            <img
                                ...
                                style={{
                                    ...
                                    marginLeft: "auto", marginRight: "auto", marginBottom: "5%"
                                }}
                            />
                            {/* <img
                        ...
                        <Col xs={7} sm={7} md={9} style={{ display: "inline-grid" }}>
                            ...
                            <Link to={"/bookqueue/" + this.state.storeName + "/" + this.state.branch}>
