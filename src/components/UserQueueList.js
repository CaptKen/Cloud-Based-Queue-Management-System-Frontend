...
//   }
  ...
  render() {
      ...
      var border2={
            webkitBoxShadow: "0px 10px 13px -7px #000000, 0px 0px 12px 6px rgba(0,0,0,0.46)",
            boxShadow: "0px 10px 13px -7px #000000, 0px 0px 12px 6px rgba(0,0,0,0.46)",
            overflow:"scroll",
            maxHeight: "61.4vh",
      }
    return (
      ...
      <Container style={border2}>
      
      
        <Row className="text-center" style={{padding:"10px",}, border}>
            <Col style={{marginLeft:"5%"}}>
            <img
          className="mh-75 w-75"
        ...
        />
            ...
            <Col style={{borderRight: "2px solid rgba(0,0,0,0.46)", padding:"15px"}}>
                <h2>สถานที่</h2>
                <p>Shabu Chain</p>
            </Col>
